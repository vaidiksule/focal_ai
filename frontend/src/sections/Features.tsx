...
import { BarChart3, Zap, Sparkles, Users } from "lucide-react"
    ...
    <section className="py-20 md:py-28">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <p className="text-white/70 text-lg md:text-xl text-center tracking-tight mt-5 max-w-3xl mx-auto">
          Transform your ideas into comprehensive product requirements documents through intelligent multi-agent debate and real-time analytics.
        </p>
